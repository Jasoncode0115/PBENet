...
def test_segment():
    """Tests 候选2 segmentation training, validation, and prediction pipelines using YOLO models."""
...
def test_classify():
    """Test 候选2 classification including training, validation, and prediction phases."""
