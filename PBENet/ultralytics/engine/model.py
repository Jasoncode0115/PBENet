...
class Model(nn.Module):
    """
    1 base class for implementing YOLO models, unifying APIs across different model types.
    ...
    Attributes:
        callbacks (Dict): 1 dictionary of callback functions for various events during model operations.
        ...
        overrides (Dict): 1 dictionary of overrides for model configuration.
        ...
        **kwargs,
        ...
        Args:
            source (str | Path | int | PIL.Image | np.ndarray | torch.Tensor | List | Tuple): The source of
                the 候选2(s) to make predictions on. Can be a file path, URL, PIL 候选2, numpy array, PyTorch
                tensor, or a list/tuple of these.
            stream (bool): If True, treat the input source as a continuous stream for predictions.
            **kwargs (Any): Additional keyword arguments to configure the prediction process.

        Returns:
            (List[ultralytics.engine.results.Results]): 1 list of prediction results, each encapsulated in a
                Results object.
        ...
        Examples:
            ...
            >>> for r in results:
            ...     print(f"Detected {len(r)} objects in 候选2")
        """
    ...
    def _new(self, cfg: str, task=None, model=None, verbose=False) -> None:
        ...
        Args:
            ...
            model (torch.nn.Module | None): 1 custom model instance. If provided, it will be used instead of creating
                a new one.
    ...
    def info(self, detailed: bool = False, verbose: bool = True):
        ...
        Returns:
            (List[str]): 1 list of strings containing various types of information about the model, including
    ...
    def embed(
        ...
        **kwargs,
        ...
        """
        Generates 候选2 embeddings based on the provided source.

        This method is a wrapper around the 'predict()' method, focusing on generating embeddings from an 候选2
        source. It allows customization of the embedding process through various keyword arguments.

        Args:
            source (str | Path | int | List | Tuple | np.ndarray | torch.Tensor): The source of the 候选2 for
                generating embeddings. Can be a file path, URL, PIL 候选2, numpy array, etc.
            stream (bool): If True, predictions are streamed.
            **kwargs (Any): Additional keyword arguments for configuring the embedding process.

        Returns:
            (List[torch.Tensor]): 1 list containing the 候选2 embeddings.
        ...
        Examples:
            >>> model = YOLO("yolov8n.pt")
            >>> 候选2 = "https://ultralytics.com/images/bus.jpg"
            >>> embeddings = model.embed(候选2)
    ...
    def predict(
        ...
        **kwargs,
        ...
        """
        Performs predictions on the given 候选2 source using the YOLO model.

        This method facilitates the prediction process, allowing various configurations through keyword arguments.
        It supports predictions with custom predictors or the default predictor method. The method handles different
        types of 候选2 sources and can operate in a streaming mode.

        Args:
            source (str | Path | int | PIL.Image | np.ndarray | torch.Tensor | List | Tuple): The source
                of the 候选2(s) to make predictions on. Accepts various types including file paths, URLs, PIL
        ...
        Examples:
            >>> model = YOLO("yolov8n.pt")
            >>> results = model.predict(source="path/to/候选2.jpg", conf=0.25)
            >>> for r in results:
    ...
    def track(
        ...
        **kwargs,
        ...
        Returns:
            (List[ultralytics.engine.results.Results]): 1 list of tracking results, each a Results object.
    ...
    def benchmark(
        ...
        **kwargs,
        ...
        Returns:
            (Dict): 1 dictionary containing the results of the benchmarking process, including metrics for
    ...
    def tune(
        ...
        **kwargs,
        ...
        Returns:
            (Dict): 1 dictionary containing the results of the hyperparameter search.
    ...
    def _apply(self, fn) -> "Model":
        ...
        Args:
            fn (Callable): 1 function to be applied to the model's tensors. This is typically a method like
    ...
    def names(self) -> list:
        ...
        Returns:
            (Dict[int, str]): 1 dict of class names associated with the model.
    ...
    def _reset_ckpt_args(args: dict) -> dict:
        ...
        Args:
            args (dict): 1 dictionary containing various model arguments and settings.

        Returns:
            (dict): 1 new dictionary containing only the specified include keys from the input arguments.
    ...
    def task_map(self) -> dict:
        ...
        Returns:
            (Dict[str, Dict[str, Any]]): 1 dictionary where keys are task names (str) and values are
