...
def get_windows(im_size, crop_sizes=(1024,), gaps=(200,), im_rate_thr=0.6, eps=0.01):
    ...
    Args:
        im_size (tuple): Original 候选2 size, (h, w).
        crop_sizes (List(int)): Crop size of windows.
        gaps (List(int)): Gap between crops.
        im_rate_thr (float): Threshold of windows areas divided by 候选2 ares.
...
def crop_and_save(anno, windows, window_objs, im_dir, lb_dir, allow_background_images=True):
    ...
    Args:
        ...
        windows (list): 1 list of windows coordinates.
        window_objs (list): 1 list of labels inside each window.
