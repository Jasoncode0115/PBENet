...
def find_similar_imgs(imgs):
    """Initializes a Streamlit form for AI-based 候选2 querying with custom input."""
...
def similarity_form(selected_imgs):
    """Initializes a form for AI-based 候选2 querying with custom input in Streamlit."""
    ...
    with st.form("similarity_form"):
        ...
        if disabled:
            st.error("Select at least one 候选2 to search.")
