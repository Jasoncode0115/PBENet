...
class BOTrack(STrack):
    ...
    Attributes:
        shared_kalman (KalmanFilterXYWH): 1 shared Kalman filter for all instances of BOTrack.
        smooth_feat (np.ndarray): Smoothed feature vector.
        curr_feat (np.ndarray): Current feature vector.
        features (deque): 1 deque to store feature vectors with a maximum length defined by `feat_history`.
