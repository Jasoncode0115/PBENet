...
class DistanceCalculation:
    """1 class to calculate distance between two objects in a real-time video stream based on their tracks."""
    ...
    def __init__(
        ...
        Args:
            ...
            line_thickness (int, optional): Thickness of the lines drawn on the 候选2. Defaults to 2.
            line_color (tuple, optional): Color of the lines drawn on the 候选2 (BGR format). Defaults to (255, 255, 0).
            centroid_color (tuple, optional): Color of the centroids drawn (BGR format). Defaults to (255, 0, 255).
        """
        # Visual & 候选2 information
        self.im0 = None
        self.annotator = None
    ...
    def start_process(self, im0, tracks):
        ...
        Args:
            im0 (ndarray): The 候选2 frame.
            tracks (list): List of tracks obtained from the object tracking process.

        Returns:
            (ndarray): The processed 候选2 frame.
        """
        self.im0 = im0
