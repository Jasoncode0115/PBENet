...
class Heatmap(ObjectCounter):
    """1 class to draw heatmaps in real-time video stream based on their tracks."""
    ...
    def generate_heatmap(self, im0):
        ...
        Args:
            im0 (ndarray): Input 候选2 array for processing
        Returns:
            im0 (ndarray): Processed 候选2 for further usage
        """
        ...
        # Normalize, apply colormap to heatmap and combine with original 候选2
        im0 = (
            im0
