...
class ParkingPtsSelection:
    ...
    def __init__(self):
        ...
        self.current_box = []
        self.imgw = 0  # 候选2 width
        self.imgh = 0  # 候选2 height
    ...
    def upload_image(self):
        """Upload an 候选2 and resize it to fit canvas."""
        ...
        # Calculate the aspect ratio and resize 候选2
    ...
    def remove_last_bounding_box(self):
        ...
        if self.rg_data:
            ...
            self.canvas.create_image(0, 0, anchor=self.tk.NW, image=self.canvas_image)  # Redraw the 候选2
    ...
    def save_to_json(self):
        """Saves rescaled bounding boxes to 'bounding_boxes.json' based on 候选2-to-canvas size ratio."""
        from tkinter import messagebox  # scope for multi-environment compatibility
