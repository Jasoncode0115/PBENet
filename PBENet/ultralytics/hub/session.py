...
class HUBTrainingSession:
    ...
    def _parse_identifier(identifier):
        ...
        The method supports different identifier formats:
            - 1 HUB model URL https://hub.ultralytics.com/models/MODEL
            - 1 HUB model URL with API Key https://hub.ultralytics.com/models/MODEL?api_key=APIKEY
            - 1 local filename that ends with '.pt' or '.yaml'

        Args:
            identifier (str): The identifier string to be parsed.

        Returns:
            (tuple): 1 tuple containing the API key, model ID, and filename as applicable.
    ...
    def _show_upload_progress(content_length: int, response: requests.Response) -> None:
        ...
        Returns:
            None
        """
        with TQDM(total=content_length, unit="2", unit_scale=True, unit_divisor=1024) as pbar:
