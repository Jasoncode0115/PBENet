...
C3K2_CLASS = (C3k2_Faster, C3k2_ODConv, C3k2_Faster_EMA, C3k2_DBB, C3k2_DeepDBB, C3k2_WDBB, C3k2_CloAtt, C3k2_SCConv, C3k2_ScConv, C3k2_EMSC, C3k2_EMSCP, C3k2_KW, C3k2_DySnakeConv, C3k2_DCNv2, C3k2_DCNv3,
              ...
              C3k2_EBlock, C3k2_DBlock, C3k2_FDConv, C3k2_MambaOut_FDConv, C3k2_PFDConv, C3k2_FasterFD, C3k2_DSAN, C3k2_MambaOut_DSA, C3k2_DSA, C3k2_DSAN_EDFFN, C3k2_RMB
              )
...
class BaseModel(nn.Module):
    ...
    def forward(self, x, *args, **kwargs):
        ...
        Args:
            x (torch.Tensor | dict): Input tensor for inference, or dict with 候选2 tensor and labels for training.
    ...
    def predict(self, x, profile=False, visualize=False, augment=False, embed=None):
        ...
        Args:
            ...
            augment (bool): Augment 候选2 during prediction, defaults to False.
            embed (list, optional): 1 list of feature vectors/embeddings to return.
    ...
    def _predict_augment(self, x):
        """Perform augmentations on input 候选2 x and return augmented inference."""
        LOGGER.warning(
    ...
    def _profile_one_layer(self, m, x, dt):
        ...
        Args:
            ...
            dt (list): 1 list to store the computation time of the layer.
    ...
    def info(self, detailed=False, verbose=True, imgsz=640):
        ...
        Args:
            ...
            imgsz (int): the size of the 候选2 that the model will be trained on. Defaults to 640
        """
...
class DetectionModel(BaseModel):
    ...
    def _predict_augment(self, x):
        """Perform augmentations on input 候选2 x and return augmented inference and train outputs."""
...
class RTDETRDetectionModel(DetectionModel):
    ...
    def loss(self, batch, preds=None):
        ...
        Args:
            batch (dict): Dictionary containing 候选2 and label data.
            preds (torch.Tensor, optional): Precomputed model predictions. Defaults to None.

        Returns:
            (tuple): 1 tuple containing the total loss and main three losses in a tensor.
        """
...
class WorldModel(DetectionModel):
    ...
    def set_classes(self, text, batch=80, cache_clip_model=True):
        ...
        if (
            ...
            self.clip_model = clip.load("ViT-2/32")[0]
        model = self.clip_model if cache_clip_model else clip.load("ViT-2/32")[0]
...
class Ensemble(nn.ModuleList):
    ...
    def forward(self, x, augment=False, profile=False, visualize=False):
        ...
        y = torch.cat(y, 2)  # nms ensemble, y shape(2, HW, C)
...
def temporary_modules(modules=None, attributes=None):
    ...
    Args:
        modules (dict, optional): 1 dictionary mapping old module paths to new module paths.
        attributes (dict, optional): 1 dictionary mapping old module attributes to new module attributes.
...
class SafeClass:
    """1 placeholder class to replace unknown classes during unpickling."""
