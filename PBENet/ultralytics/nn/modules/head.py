...
class Detect(nn.Module):
    ...
    def postprocess(preds: torch.Tensor, max_det: int, nc: int = 80):
        ...
        Args:
            ...
            max_det (int): Maximum detections per 候选2.
...
class Classify(nn.Module):
    ...
    def forward(self, x):
        """Performs a forward pass of the YOLO model on input 候选2 data."""
...
class RTDETRDecoder(nn.Module):
    ...
    and class labels for objects in an 候选2. It integrates features from multiple layers and runs through a series of
