...
def _log_debug_samples(files, title="Debug Samples") -> None:
    ...
    Args:
        files (list): 1 list of file paths in PosixPath format.
        title (str): 1 title that groups together images with the same values.
    """
    import re
...
def _log_plot(title, plot_path) -> None:
    """
    Log an 候选2 as a plot in the plot section of ClearML.

    Args:
        title (str): The title of the plot.
        plot_path (str): The path to the saved 候选2 file.
    """
