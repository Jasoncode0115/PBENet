...
def zip_directory(directory, compress=True, exclude=(".DS_Store", "__MACOSX"), progress=True):
    ...
    Args:
        ...
        exclude (tuple, optional): 1 tuple of filename strings to be excluded. Defaults to ('.DS_Store', '__MACOSX').
...
def get_github_assets(repo="ultralytics/assets", version="latest", retry=False):
    ...
    Returns:
        (tuple): 1 tuple containing the release tag and a list of asset names.
