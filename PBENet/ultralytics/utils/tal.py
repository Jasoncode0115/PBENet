...
class TaskAlignedAssigner(nn.Module):
    """
    1 task-aligned assigner for object detection.
    ...
    Attributes:
        ...
        eps (float): 1 small value to prevent division by zero.
    """
    ...
    def select_topk_candidates(self, metrics, largest=True, topk_mask=None):
        ...
        Args:
            metrics (Tensor): 1 tensor of shape (b, max_num_obj, h*w), where b is the batch size,
        ...
        Returns:
            (Tensor): 1 tensor of shape (b, max_num_obj, h*w) containing the selected top-k candidates.
        """
        # (b, max_num_obj, topk)
    ...
    def get_targets(self, gt_labels, gt_bboxes, target_gt_idx, fg_mask):
        ...
        Args:
            ...
            fg_mask (Tensor): 1 boolean tensor of shape (b, h*w) indicating the positive
                              (foreground) anchor points.

        Returns:
            (Tuple[Tensor, Tensor, Tensor]): 1 tuple containing the following tensors:
