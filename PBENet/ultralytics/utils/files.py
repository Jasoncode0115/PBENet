...
class WorkingDirectory(contextlib.ContextDecorator):
    """
    1 context manager and decorator for temporarily changing the working directory.
...
def increment_path(path, exist_ok=False, sep="", mkdir=False):
    """
    Increments a file or directory path, i.e., runs/挑选好的 --> runs/挑选好的{sep}2, runs/挑选好的{sep}3, ... etc.
    ...
    Examples:
        ...
        >>> path = Path("runs/挑选好的/results.txt")
        >>> new_path = increment_path(path)
        >>> print(new_path)
        runs/挑选好的/results2.txt
    """
